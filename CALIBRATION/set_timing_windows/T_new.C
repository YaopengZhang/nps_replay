...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TH1F* h_EL_HI = new TH1F("h_EL_HI","h_EL_HI; TdcTimeRaw; Counts",600,2000,3200);
   TH1F* h_EL_LO = new TH1F("h_EL_LO","h_EL_LO; TdcTimeRaw; Counts",600,2000,3200);
   TH1F* h_EL_REAL = new TH1F("h_EL_REAL","h_EL_REAL; TdcTimeRaw; Counts",600,2000,3200);
   h_cal->SetLineColor(kBlack);     // 0 1 2 3
   h_EL_HI->SetLineColor(kBlack);   // 0 1 2
   h_EL_LO->SetLineColor(kBlack);   // 0 1 2
   h_EL_REAL->SetLineColor(kBlack); // 0 1 2

   TH1F* h_cal_mult1 = new TH1F("hcal_mult1","hcal_1pr_goodPosAdcTdcDiffTime (PMT1);Channels 0.0625 ns / Ch;Counts",750,-100,50);
   TH1F* h_EL_HI_mult1 = new TH1F("h_EL_HI_mult1","h_EL_HI; TdcTimeRaw; Counts",600,2000,3200);
   TH1F* h_EL_LO_mult1 = new TH1F("h_EL_LO_mult1","h_EL_LO; TdcTimeRaw; Counts",600,2000,3200);
   TH1F* h_EL_REAL_mult1 = new TH1F("h_EL_REAL_mult1","h_EL_REAL; TdcTimeRaw; Counts",600,2000,3200);
   h_cal_mult1->SetLineColor(kRed);     // 0 1 2 3
   h_EL_HI_mult1->SetLineColor(kRed);   // 0 1 2
   h_EL_LO_mult1->SetLineColor(kRed);   // 0 1 2
   h_EL_REAL_mult1->SetLineColor(kRed); // 0 1 2

   TH1F* h_cal_mult2 = new TH1F("hcal_mult2","hcal_1pr_goodPosAdcTdcDiffTime (PMT1);Channels 0.0625 ns / Ch;Counts",750,-100,50);
   TH1F* h_EL_HI_mult2 = new TH1F("h_EL_HI_mult2","h_EL_HI; TdcTimeRaw; Counts",600,2000,3200);
   TH1F* h_EL_LO_mult2 = new TH1F("h_EL_LO_mult2","h_EL_LO; TdcTimeRaw; Counts",600,2000,3200);
   TH1F* h_EL_REAL_mult2 = new TH1F("h_EL_REAL_mult2","h_EL_REAL; TdcTimeRaw; Counts",600,2000,3200);
   h_cal_mult2->SetLineColor(kBlue);     // 0 1 2 3
   h_EL_HI_mult2->SetLineColor(kBlue);   // 0 1 2
   h_EL_LO_mult2->SetLineColor(kBlue);   // 0 1 2
   h_EL_REAL_mult2->SetLineColor(kBlue); // 0 1 2

   TH1F* h_cal_mult3 = new TH1F("hcal_mult3","hcal_1pr_goodPosAdcTdcDiffTime (PMT1);Channels 0.0625 ns / Ch;Counts",750,-100,50);
   TH1F* h_EL_HI_mult3 = new TH1F("h_EL_HI_mult3","h_EL_HI; TdcTimeRaw; Counts",600,2000,3200);
   TH1F* h_EL_LO_mult3 = new TH1F("h_EL_LO_mult3","h_EL_LO; TdcTimeRaw; Counts",600,2000,3200);
   TH1F* h_EL_REAL_mult3 = new TH1F("h_EL_REAL_mult3","h_EL_REAL; TdcTimeRaw; Counts",600,2000,3200);
   h_cal_mult3->SetLineColor(kGreen);     // 0 1 2 3
   h_EL_HI_mult3->SetLineColor(kGreen);   // 0 1 2
   h_EL_LO_mult3->SetLineColor(kGreen);   // 0 1 2
   h_EL_REAL_mult3->SetLineColor(kGreen); // 0 1 2
   ...
   int Flag_Cal = 1;    // 0 1 2 3
   int Flag_REAL = 1;   // -1 0 1 2 
   int Flag_HI = 0;     // -1 0 1 2 
   int Flag_LO = 2;     // -1 0 1 2 
   ...
   // for (Long64_t jentry=0; jentry<5000;jentry++) {
      ...
      // h_cal->Fill(H_cal_1pr_goodPosAdcTdcDiffTime[0]); // 0 1 2 3
      // h_EL_HI->Fill(T_hms_hEL_HI_vecTdcTimeRaw[0]); // 0 1 2
      // h_EL_LO->Fill(T_hms_hEL_LO_vecTdcTimeRaw[0]); // 0 1 2 
      // h_EL_REAL->Fill(T_hms_hEL_REAL_vecTdcTimeRaw[0]); // 0 1 2

      if(Flag_Cal==0 && H_cal_1pr_goodPosAdcMult[0]<0.5) continue;
      if(Flag_Cal>0 && (H_cal_1pr_goodPosAdcMult[0]<Flag_Cal-0.5||H_cal_1pr_goodPosAdcMult[0]>Flag_Cal+0.5)) continue;
      if(Flag_Cal<0 && H_cal_1pr_goodPosAdcMult[0]>0.5) continue;

      if(Flag_REAL==0 && T_hms_hEL_REAL_tdcMultiplicity<0.5) continue;
      if(Flag_REAL>0 && (T_hms_hEL_REAL_tdcMultiplicity<Flag_REAL-0.5||T_hms_hEL_REAL_tdcMultiplicity>Flag_REAL+0.5)) continue;
      if(Flag_REAL<0 && T_hms_hEL_REAL_tdcMultiplicity>0.5) continue;

      if(Flag_HI==0 && T_hms_hEL_HI_tdcMultiplicity<0.5) continue;
      if(Flag_HI>0 && (T_hms_hEL_HI_tdcMultiplicity<Flag_HI-0.5||T_hms_hEL_HI_tdcMultiplicity>Flag_HI+0.5)) continue;
      if(Flag_HI<0 && T_hms_hEL_HI_tdcMultiplicity>0.5) continue;

      if(Flag_LO==0 && T_hms_hEL_LO_tdcMultiplicity<0.5) continue;
      if(Flag_LO>0 && (T_hms_hEL_LO_tdcMultiplicity<Flag_LO-0.5||T_hms_hEL_LO_tdcMultiplicity>Flag_LO+0.5)) continue;
      if(Flag_LO<0 && T_hms_hEL_LO_tdcMultiplicity>0.5) continue;

      h_cal->Fill(H_cal_1pr_goodPosAdcTdcDiffTime[0]);
      h_EL_HI->Fill(T_hms_hEL_HI_tdcTimeRaw);
      h_EL_LO->Fill(T_hms_hEL_LO_tdcTimeRaw);
      h_EL_REAL->Fill(T_hms_hEL_REAL_tdcTimeRaw);
      ...
      if(T_hms_hEL_LO_tdcMultiplicity>0.5){
         h_cal_mult2->Fill(H_cal_1pr_goodPosAdcTdcDiffTime[0]);
         h_EL_LO_mult2->Fill(T_hms_hEL_LO_tdcTimeRaw);
         h_EL_REAL_mult2->Fill(T_hms_hEL_REAL_tdcTimeRaw);
      }

      if(T_hms_hEL_HI_tdcMultiplicity>0.5){
         h_cal_mult1->Fill(H_cal_1pr_goodPosAdcTdcDiffTime[0]);
         h_EL_HI_mult1->Fill(T_hms_hEL_HI_tdcTimeRaw);
         h_EL_REAL_mult1->Fill(T_hms_hEL_REAL_tdcTimeRaw);
      }
   ...
   TCanvas* c_all = new TCanvas("c_all","c_all",1200,800);
   c_all->Divide(2,2);
   c_all->cd(1); gPad->SetLogy(1); h_cal->Draw();
   c_all->cd(2); gPad->SetLogy(1); h_EL_REAL->Draw();
   c_all->cd(3); gPad->SetLogy(1); h_EL_LO->Draw();
   c_all->cd(4); gPad->SetLogy(1); h_EL_HI->Draw();
   TLatex label;
   c_all->cd();
   TString Print_info = "Multiplicity Cuts: ";
   if(Flag_Cal==0) Print_info = Print_info + "Calo no cut, ";
   else if(Flag_Cal<0) Print_info = Print_info + "Calo mult = 0, ";
   else Print_info = Print_info + Form("Calo mult = %d, ",Flag_Cal);

   if(Flag_REAL==0) Print_info = Print_info + "EL_REAL no cut, ";
   else if(Flag_REAL<0) Print_info = Print_info + "EL_REAL mult = 0, ";
   else Print_info = Print_info + Form("EL_REAL mult = %d, ",Flag_REAL);

   if(Flag_HI==0) Print_info = Print_info + "EL_HI no cut, ";
   else if(Flag_HI<0) Print_info = Print_info + "EL_HI mult = 0, ";
   else Print_info = Print_info + Form("EL_HI mult = %d, ",Flag_HI);

   if(Flag_LO==0) Print_info = Print_info + "EL_LO no cut, ";
   else if(Flag_LO<0) Print_info = Print_info + "EL_LO mult = 0, ";
   else Print_info = Print_info + Form("EL_LO mult = %d, ",Flag_LO);

   label.SetNDC();
   label.SetTextSize(0.02);
   label.DrawLatex(0.01, 0.01, Print_info);
   c_all->SaveAs("Cal_Check_plots/All.pdf");
