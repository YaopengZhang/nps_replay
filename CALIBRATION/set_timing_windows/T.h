...
// Sun Jul 28 22:40:55 2024 by ROOT version 6.30/04
// from TTree T/Hall A Analyzer Output DST
// found on file: ../../ROOTfiles/NPS/50k/nps_hms_notiming_window_1753_50000.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        H_cal_1pr_negAdcCounter[7];   //[Ndata.H.cal.1pr.negAdcCounter]
   Int_t           Ndata_H_cal_1pr_negAdcErrorFlag;
   Double_t        H_cal_1pr_negAdcErrorFlag[7];   //[Ndata.H.cal.1pr.negAdcErrorFlag]
   Int_t           Ndata_H_cal_1pr_negAdcPed;
   Double_t        H_cal_1pr_negAdcPed[7];   //[Ndata.H.cal.1pr.negAdcPed]
   Int_t           Ndata_H_cal_1pr_negAdcPedRaw;
   Double_t        H_cal_1pr_negAdcPedRaw[7];   //[Ndata.H.cal.1pr.negAdcPedRaw]
   Int_t           Ndata_H_cal_1pr_negAdcPulseAmp;
   Double_t        H_cal_1pr_negAdcPulseAmp[7];   //[Ndata.H.cal.1pr.negAdcPulseAmp]
   Int_t           Ndata_H_cal_1pr_negAdcPulseAmpRaw;
   Double_t        H_cal_1pr_negAdcPulseAmpRaw[7];   //[Ndata.H.cal.1pr.negAdcPulseAmpRaw]
   Int_t           Ndata_H_cal_1pr_negAdcPulseInt;
   Double_t        H_cal_1pr_negAdcPulseInt[7];   //[Ndata.H.cal.1pr.negAdcPulseInt]
   Int_t           Ndata_H_cal_1pr_negAdcPulseIntRaw;
   Double_t        H_cal_1pr_negAdcPulseIntRaw[7];   //[Ndata.H.cal.1pr.negAdcPulseIntRaw]
   Int_t           Ndata_H_cal_1pr_negAdcPulseTime;
   Double_t        H_cal_1pr_negAdcPulseTime[7];   //[Ndata.H.cal.1pr.negAdcPulseTime]
   Int_t           Ndata_H_cal_1pr_negAdcPulseTimeRaw;
   Double_t        H_cal_1pr_negAdcPulseTimeRaw[7];   //[Ndata.H.cal.1pr.negAdcPulseTimeRaw]
   ...
   Double_t        H_cal_1pr_posAdcCounter[10];   //[Ndata.H.cal.1pr.posAdcCounter]
   Int_t           Ndata_H_cal_1pr_posAdcErrorFlag;
   Double_t        H_cal_1pr_posAdcErrorFlag[10];   //[Ndata.H.cal.1pr.posAdcErrorFlag]
   Int_t           Ndata_H_cal_1pr_posAdcPed;
   Double_t        H_cal_1pr_posAdcPed[10];   //[Ndata.H.cal.1pr.posAdcPed]
   Int_t           Ndata_H_cal_1pr_posAdcPedRaw;
   Double_t        H_cal_1pr_posAdcPedRaw[10];   //[Ndata.H.cal.1pr.posAdcPedRaw]
   Int_t           Ndata_H_cal_1pr_posAdcPulseAmp;
   Double_t        H_cal_1pr_posAdcPulseAmp[10];   //[Ndata.H.cal.1pr.posAdcPulseAmp]
   Int_t           Ndata_H_cal_1pr_posAdcPulseAmpRaw;
   Double_t        H_cal_1pr_posAdcPulseAmpRaw[10];   //[Ndata.H.cal.1pr.posAdcPulseAmpRaw]
   Int_t           Ndata_H_cal_1pr_posAdcPulseInt;
   Double_t        H_cal_1pr_posAdcPulseInt[10];   //[Ndata.H.cal.1pr.posAdcPulseInt]
   Int_t           Ndata_H_cal_1pr_posAdcPulseIntRaw;
   Double_t        H_cal_1pr_posAdcPulseIntRaw[10];   //[Ndata.H.cal.1pr.posAdcPulseIntRaw]
   Int_t           Ndata_H_cal_1pr_posAdcPulseTime;
   Double_t        H_cal_1pr_posAdcPulseTime[10];   //[Ndata.H.cal.1pr.posAdcPulseTime]
   Int_t           Ndata_H_cal_1pr_posAdcPulseTimeRaw;
   Double_t        H_cal_1pr_posAdcPulseTimeRaw[10];   //[Ndata.H.cal.1pr.posAdcPulseTimeRaw]
   ...
   Double_t        H_cal_2ta_negAdcCounter[7];   //[Ndata.H.cal.2ta.negAdcCounter]
   Int_t           Ndata_H_cal_2ta_negAdcErrorFlag;
   Double_t        H_cal_2ta_negAdcErrorFlag[7];   //[Ndata.H.cal.2ta.negAdcErrorFlag]
   Int_t           Ndata_H_cal_2ta_negAdcPed;
   Double_t        H_cal_2ta_negAdcPed[7];   //[Ndata.H.cal.2ta.negAdcPed]
   Int_t           Ndata_H_cal_2ta_negAdcPedRaw;
   Double_t        H_cal_2ta_negAdcPedRaw[7];   //[Ndata.H.cal.2ta.negAdcPedRaw]
   Int_t           Ndata_H_cal_2ta_negAdcPulseAmp;
   Double_t        H_cal_2ta_negAdcPulseAmp[7];   //[Ndata.H.cal.2ta.negAdcPulseAmp]
   Int_t           Ndata_H_cal_2ta_negAdcPulseAmpRaw;
   Double_t        H_cal_2ta_negAdcPulseAmpRaw[7];   //[Ndata.H.cal.2ta.negAdcPulseAmpRaw]
   Int_t           Ndata_H_cal_2ta_negAdcPulseInt;
   Double_t        H_cal_2ta_negAdcPulseInt[7];   //[Ndata.H.cal.2ta.negAdcPulseInt]
   Int_t           Ndata_H_cal_2ta_negAdcPulseIntRaw;
   Double_t        H_cal_2ta_negAdcPulseIntRaw[7];   //[Ndata.H.cal.2ta.negAdcPulseIntRaw]
   Int_t           Ndata_H_cal_2ta_negAdcPulseTime;
   Double_t        H_cal_2ta_negAdcPulseTime[7];   //[Ndata.H.cal.2ta.negAdcPulseTime]
   Int_t           Ndata_H_cal_2ta_negAdcPulseTimeRaw;
   Double_t        H_cal_2ta_negAdcPulseTimeRaw[7];   //[Ndata.H.cal.2ta.negAdcPulseTimeRaw]
   ...
   Double_t        H_cal_2ta_posAdcCounter[11];   //[Ndata.H.cal.2ta.posAdcCounter]
   Int_t           Ndata_H_cal_2ta_posAdcErrorFlag;
   Double_t        H_cal_2ta_posAdcErrorFlag[11];   //[Ndata.H.cal.2ta.posAdcErrorFlag]
   Int_t           Ndata_H_cal_2ta_posAdcPed;
   Double_t        H_cal_2ta_posAdcPed[11];   //[Ndata.H.cal.2ta.posAdcPed]
   Int_t           Ndata_H_cal_2ta_posAdcPedRaw;
   Double_t        H_cal_2ta_posAdcPedRaw[11];   //[Ndata.H.cal.2ta.posAdcPedRaw]
   Int_t           Ndata_H_cal_2ta_posAdcPulseAmp;
   Double_t        H_cal_2ta_posAdcPulseAmp[11];   //[Ndata.H.cal.2ta.posAdcPulseAmp]
   Int_t           Ndata_H_cal_2ta_posAdcPulseAmpRaw;
   Double_t        H_cal_2ta_posAdcPulseAmpRaw[11];   //[Ndata.H.cal.2ta.posAdcPulseAmpRaw]
   Int_t           Ndata_H_cal_2ta_posAdcPulseInt;
   Double_t        H_cal_2ta_posAdcPulseInt[11];   //[Ndata.H.cal.2ta.posAdcPulseInt]
   Int_t           Ndata_H_cal_2ta_posAdcPulseIntRaw;
   Double_t        H_cal_2ta_posAdcPulseIntRaw[11];   //[Ndata.H.cal.2ta.posAdcPulseIntRaw]
   Int_t           Ndata_H_cal_2ta_posAdcPulseTime;
   Double_t        H_cal_2ta_posAdcPulseTime[11];   //[Ndata.H.cal.2ta.posAdcPulseTime]
   Int_t           Ndata_H_cal_2ta_posAdcPulseTimeRaw;
   Double_t        H_cal_2ta_posAdcPulseTimeRaw[11];   //[Ndata.H.cal.2ta.posAdcPulseTimeRaw]
   ...
   Double_t        H_cal_3ta_posAdcCounter[6];   //[Ndata.H.cal.3ta.posAdcCounter]
   Int_t           Ndata_H_cal_3ta_posAdcErrorFlag;
   Double_t        H_cal_3ta_posAdcErrorFlag[6];   //[Ndata.H.cal.3ta.posAdcErrorFlag]
   Int_t           Ndata_H_cal_3ta_posAdcPed;
   Double_t        H_cal_3ta_posAdcPed[6];   //[Ndata.H.cal.3ta.posAdcPed]
   Int_t           Ndata_H_cal_3ta_posAdcPedRaw;
   Double_t        H_cal_3ta_posAdcPedRaw[6];   //[Ndata.H.cal.3ta.posAdcPedRaw]
   Int_t           Ndata_H_cal_3ta_posAdcPulseAmp;
   Double_t        H_cal_3ta_posAdcPulseAmp[6];   //[Ndata.H.cal.3ta.posAdcPulseAmp]
   Int_t           Ndata_H_cal_3ta_posAdcPulseAmpRaw;
   Double_t        H_cal_3ta_posAdcPulseAmpRaw[6];   //[Ndata.H.cal.3ta.posAdcPulseAmpRaw]
   Int_t           Ndata_H_cal_3ta_posAdcPulseInt;
   Double_t        H_cal_3ta_posAdcPulseInt[6];   //[Ndata.H.cal.3ta.posAdcPulseInt]
   Int_t           Ndata_H_cal_3ta_posAdcPulseIntRaw;
   Double_t        H_cal_3ta_posAdcPulseIntRaw[6];   //[Ndata.H.cal.3ta.posAdcPulseIntRaw]
   Int_t           Ndata_H_cal_3ta_posAdcPulseTime;
   Double_t        H_cal_3ta_posAdcPulseTime[6];   //[Ndata.H.cal.3ta.posAdcPulseTime]
   Int_t           Ndata_H_cal_3ta_posAdcPulseTimeRaw;
   Double_t        H_cal_3ta_posAdcPulseTimeRaw[6];   //[Ndata.H.cal.3ta.posAdcPulseTimeRaw]
   Int_t           Ndata_H_cal_3ta_posAdcSampPed;
   Double_t        H_cal_3ta_posAdcSampPed[2];   //[Ndata.H.cal.3ta.posAdcSampPed]
   Int_t           Ndata_H_cal_3ta_posAdcSampPedRaw;
   Double_t        H_cal_3ta_posAdcSampPedRaw[2];   //[Ndata.H.cal.3ta.posAdcSampPedRaw]
   Int_t           Ndata_H_cal_3ta_posAdcSampPulseAmp;
   Double_t        H_cal_3ta_posAdcSampPulseAmp[2];   //[Ndata.H.cal.3ta.posAdcSampPulseAmp]
   Int_t           Ndata_H_cal_3ta_posAdcSampPulseAmpRaw;
   Double_t        H_cal_3ta_posAdcSampPulseAmpRaw[2];   //[Ndata.H.cal.3ta.posAdcSampPulseAmpRaw]
   Int_t           Ndata_H_cal_3ta_posAdcSampPulseInt;
   Double_t        H_cal_3ta_posAdcSampPulseInt[2];   //[Ndata.H.cal.3ta.posAdcSampPulseInt]
   Int_t           Ndata_H_cal_3ta_posAdcSampPulseIntRaw;
   Double_t        H_cal_3ta_posAdcSampPulseIntRaw[2];   //[Ndata.H.cal.3ta.posAdcSampPulseIntRaw]
   Int_t           Ndata_H_cal_3ta_posAdcSampPulseTime;
   Double_t        H_cal_3ta_posAdcSampPulseTime[2];   //[Ndata.H.cal.3ta.posAdcSampPulseTime]
   Int_t           Ndata_H_cal_3ta_posAdcSampPulseTimeRaw;
   Double_t        H_cal_3ta_posAdcSampPulseTimeRaw[2];   //[Ndata.H.cal.3ta.posAdcSampPulseTimeRaw]
   ...
   Double_t        H_cal_4ta_posAdcCounter[6];   //[Ndata.H.cal.4ta.posAdcCounter]
   Int_t           Ndata_H_cal_4ta_posAdcErrorFlag;
   Double_t        H_cal_4ta_posAdcErrorFlag[6];   //[Ndata.H.cal.4ta.posAdcErrorFlag]
   Int_t           Ndata_H_cal_4ta_posAdcPed;
   Double_t        H_cal_4ta_posAdcPed[6];   //[Ndata.H.cal.4ta.posAdcPed]
   Int_t           Ndata_H_cal_4ta_posAdcPedRaw;
   Double_t        H_cal_4ta_posAdcPedRaw[6];   //[Ndata.H.cal.4ta.posAdcPedRaw]
   Int_t           Ndata_H_cal_4ta_posAdcPulseAmp;
   Double_t        H_cal_4ta_posAdcPulseAmp[6];   //[Ndata.H.cal.4ta.posAdcPulseAmp]
   Int_t           Ndata_H_cal_4ta_posAdcPulseAmpRaw;
   Double_t        H_cal_4ta_posAdcPulseAmpRaw[6];   //[Ndata.H.cal.4ta.posAdcPulseAmpRaw]
   Int_t           Ndata_H_cal_4ta_posAdcPulseInt;
   Double_t        H_cal_4ta_posAdcPulseInt[6];   //[Ndata.H.cal.4ta.posAdcPulseInt]
   Int_t           Ndata_H_cal_4ta_posAdcPulseIntRaw;
   Double_t        H_cal_4ta_posAdcPulseIntRaw[6];   //[Ndata.H.cal.4ta.posAdcPulseIntRaw]
   Int_t           Ndata_H_cal_4ta_posAdcPulseTime;
   Double_t        H_cal_4ta_posAdcPulseTime[6];   //[Ndata.H.cal.4ta.posAdcPulseTime]
   Int_t           Ndata_H_cal_4ta_posAdcPulseTimeRaw;
   Double_t        H_cal_4ta_posAdcPulseTimeRaw[6];   //[Ndata.H.cal.4ta.posAdcPulseTimeRaw]
   Int_t           Ndata_H_cal_4ta_posAdcSampPed;
   Double_t        H_cal_4ta_posAdcSampPed[5];   //[Ndata.H.cal.4ta.posAdcSampPed]
   Int_t           Ndata_H_cal_4ta_posAdcSampPedRaw;
   Double_t        H_cal_4ta_posAdcSampPedRaw[5];   //[Ndata.H.cal.4ta.posAdcSampPedRaw]
   Int_t           Ndata_H_cal_4ta_posAdcSampPulseAmp;
   Double_t        H_cal_4ta_posAdcSampPulseAmp[5];   //[Ndata.H.cal.4ta.posAdcSampPulseAmp]
   Int_t           Ndata_H_cal_4ta_posAdcSampPulseAmpRaw;
   Double_t        H_cal_4ta_posAdcSampPulseAmpRaw[5];   //[Ndata.H.cal.4ta.posAdcSampPulseAmpRaw]
   Int_t           Ndata_H_cal_4ta_posAdcSampPulseInt;
   Double_t        H_cal_4ta_posAdcSampPulseInt[5];   //[Ndata.H.cal.4ta.posAdcSampPulseInt]
   Int_t           Ndata_H_cal_4ta_posAdcSampPulseIntRaw;
   Double_t        H_cal_4ta_posAdcSampPulseIntRaw[5];   //[Ndata.H.cal.4ta.posAdcSampPulseIntRaw]
   Int_t           Ndata_H_cal_4ta_posAdcSampPulseTime;
   Double_t        H_cal_4ta_posAdcSampPulseTime[5];   //[Ndata.H.cal.4ta.posAdcSampPulseTime]
   Int_t           Ndata_H_cal_4ta_posAdcSampPulseTimeRaw;
   Double_t        H_cal_4ta_posAdcSampPulseTimeRaw[5];   //[Ndata.H.cal.4ta.posAdcSampPulseTimeRaw]
   Int_t           Ndata_T_hms_hEL_CLEAN_vecTdcTime;
   Double_t        T_hms_hEL_CLEAN_vecTdcTime[2];   //[Ndata.T.hms.hEL_CLEAN_vecTdcTime]
   Int_t           Ndata_T_hms_hEL_CLEAN_vecTdcTimeRaw;
   Double_t        T_hms_hEL_CLEAN_vecTdcTimeRaw[2];   //[Ndata.T.hms.hEL_CLEAN_vecTdcTimeRaw]
   Int_t           Ndata_T_hms_hEL_HI_vecTdcTime;
   Double_t        T_hms_hEL_HI_vecTdcTime[2];   //[Ndata.T.hms.hEL_HI_vecTdcTime]
   Int_t           Ndata_T_hms_hEL_HI_vecTdcTimeRaw;
   Double_t        T_hms_hEL_HI_vecTdcTimeRaw[2];   //[Ndata.T.hms.hEL_HI_vecTdcTimeRaw]
   Int_t           Ndata_T_hms_hEL_LO_LO_vecTdcTime;
   Double_t        T_hms_hEL_LO_LO_vecTdcTime[3];   //[Ndata.T.hms.hEL_LO_LO_vecTdcTime]
   Int_t           Ndata_T_hms_hEL_LO_LO_vecTdcTimeRaw;
   Double_t        T_hms_hEL_LO_LO_vecTdcTimeRaw[3];   //[Ndata.T.hms.hEL_LO_LO_vecTdcTimeRaw]
   ...
   Double_t        T_hms_hEL_REAL_vecTdcTime[3];   //[Ndata.T.hms.hEL_REAL_vecTdcTime]
   Int_t           Ndata_T_hms_hEL_REAL_vecTdcTimeRaw;
   Double_t        T_hms_hEL_REAL_vecTdcTimeRaw[3];   //[Ndata.T.hms.hEL_REAL_vecTdcTimeRaw]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTfiles/NPS/50k/nps_hms_notiming_window_1753_50000.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTfiles/NPS/50k/nps_hms_notiming_window_1753_50000.root");
      }
      f->GetObject("T",tree);
